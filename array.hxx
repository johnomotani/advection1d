...
// Allows us to create a std::vector which has memory allocated by fftw_malloc, required
// for correct alignment by FFTW, which (sometimes) allows better performance.
template<class T>
