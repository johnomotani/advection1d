#ifndef __CHEBYSHEV_FFT_R2C_H__
#define __CHEBYSHEV_FFT_R2C_H__
...
/// rhs = - v * df/dz
class ChebyshevFFT_r2c {
public:
  ChebyshevFFT_r2c(const Parameters &parameters);
